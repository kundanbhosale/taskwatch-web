...
const TermsConditionsPage = () => {
  return (
    <section className='ts mx-auto my-10 max-w-screen-lg px-4'>
      <h1 className='text-3xl md:text-4xl'>Terms and Conditions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Taskwatch.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Taskwatch, accessible from
            <Link
              href='https://www.taskwatch.io'
              rel='external nofollow noopener'
              target='_blank'
            >
              http://www.taskwatch.io
            </Link>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: kundanmbhosale@gmail.com</li>
      </ul>
    </section>
  )
}
